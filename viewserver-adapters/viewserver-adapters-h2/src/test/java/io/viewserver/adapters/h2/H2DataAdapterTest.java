...
//        Assert.assertEquals("username", deserialised.getUsername());
//        Assert.assertEquals("password", deserialised.getPassword());
//        Assert.assertEquals("tableName", deserialised.getTableName());
//    }
}
