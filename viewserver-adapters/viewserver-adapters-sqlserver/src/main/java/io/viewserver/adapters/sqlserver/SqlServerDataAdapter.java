...
public class SqlServerDataAdapter extends JdbcDataAdapterBase {
    ...
    public SqlServerDataAdapter(String server, Integer port, String instance, String database, String username, String password, IWritableDataQueryProvider dataQueryProvider) {
