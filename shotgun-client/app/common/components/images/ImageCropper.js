...
const ClipRect = require('./clipRect');
...
export default class ImageCropper extends Component {
  ...
  componentWillMount() {
    const {editRectWidth = 200, editRectHeight = 200,  editRectRadius = 25,  overlayColor = 'rgba(0, 0, 0, 0.5)', imageWidth, imageHeight} = this.props;
  ...
  render() {
    ...
    const {editRectWidth, editRectHeight, editRectRadius, source, style,  overlayColor = 'rgba(0, 0, 0, 0.5)'} = this.props;
    return (
