...
class ProductCategoryList extends Component {
  ...
  renderSelectionControl = ({categoryObj, selectedProductCategories = []}) => {
    ...
    const implicitlyChecked = this.isImplicitlyChecked(categoryObj, selectedProductCategories);
    return <CheckBox key={categoryObj.categoryId} onPress={() => this.toggleCategory(categoryObj)} categorySelectionCheckbox checked={checked} implicitylChecked={implicitlyChecked}/>;
  }
