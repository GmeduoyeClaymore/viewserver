...
class DriverOrderRequests extends Component{
  ...
  render(){
    ...
    return <Container>
      ...
      {selectedContentTypes[0] ? <ReduxRouter  name="DriverOrderRequestRouter" height={height - 150} defaultRoute={`${path}/ContentTypeId${selectedContentTypes[0].contentTypeId}X`} {...{busy, selectedContentTypes, history, path, parentPath, contentTypeOptions}}>
