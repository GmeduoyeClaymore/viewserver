...
const DriverMenuBar = ({history, path}) => {
  return <Footer>
    ...
    <FooterTab><Button transparent onPress={() => history.just({pathname: `${path}/DriverOrderRequests`})}><Image source={AppImages.spanner} style={styles.image}/></Button></FooterTab>
