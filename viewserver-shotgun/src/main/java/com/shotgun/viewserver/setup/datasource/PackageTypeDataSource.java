 ...
 */
public class
PackageTypeDataSource {
    public static final String NAME = "packageTypes";

    public static DataSource getDataSource() {
        CsvDataAdapter dataAdapter = new CsvDataAdapter();
        dataAdapter.setFileName("data/packageTypes.csv");
        return new DataSource()
                ...
                .withSchema(new Schema()
                        .withColumns(Arrays.asList(
                                new Column("Package Code", "Package Code", ColumnType.String),
                                new Column("Package Name", "Package Name", ColumnType.String)
                        ))
                )
                /*.withNodes(
