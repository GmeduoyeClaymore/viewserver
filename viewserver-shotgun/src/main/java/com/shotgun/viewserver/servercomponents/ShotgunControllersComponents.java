...
import com.shotgun.viewserver.error.ClientErrorController;
...
public abstract class ShotgunControllersComponents extends ControllerComponents{
    ...
    public Observable start() {
        ...
        ClientErrorController clientErrorController = new ClientErrorController();
        ...
        this.registerController(clientErrorController);
