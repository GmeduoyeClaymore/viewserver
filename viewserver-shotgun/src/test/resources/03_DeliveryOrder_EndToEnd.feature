Feature: Delivery order scenarios
  ...
  Scenario: Responding to order causes order to appear in responded order list for partner
	...
	Then "client1" the following data is received eventually on report "customerOrderSummary"
	  ...
	  | RowAdd  |               | {client1_deliveryOrderController_createOrder_result} | ref://json/orders/deliveryOrder.json | 1                  | ref://json/orders/deliveryOrderLocation.json | PLACED | {"{client2_partnerController_registerPartner_result}" : {"responseStatus":"RESPONDED", "spreadPartnerId" : "{client2_partnerController_registerPartner_result}"}} |
  ...
  Scenario: Accepting response causes order status to change to accepted for partner then declined for the remaining partners
	...
	Then "client1" the following data is received eventually on report "customerOrderSummary"
	  ...
	  | RowAdd  | {client1_deliveryOrderController_createOrder_result} | { "{client2_partnerController_registerPartner_result}" : {"spreadPartnerId":"{client2_partnerController_registerPartner_result}"} ,  "{client3_partnerController_registerPartner_result}" : {"spreadPartnerId":"{client3_partnerController_registerPartner_result}"}} |
	Then "client3" the following data is received eventually on report "orderResponses"
	  | ~Action | orderId                                              | responseStatus |
  ...
  Scenario: Partner completing job marking job marks job as partner complete and payment made
	...
	Given "client1" controller "deliveryOrderController" action "createOrder" invoked with data file "json/orders/createDeliveryOrder.json" with parameters
	  | Name             | Value                                              |
	  | param_customerId | {client1_partnerController_registerPartner_result} |
	Given "client1" controller "deliveryOrderController" action "createOrder" invoked with data file "json/orders/createDeliveryOrder.json" with parameters and result name suffix "_1"
	  | Name             | Value                                              |
	  | param_customerId | {client1_partnerController_registerPartner_result} |
	Given "client1" controller "deliveryOrderController" action "createOrder" invoked with data file "json/orders/createDeliveryOrder.json" with parameters and result name suffix "_2"
	  | Name             | Value                                              |
	  | param_customerId | {client1_partnerController_registerPartner_result} |
	Given "client2" controller "deliveryOrderController" action "respondToOrder" invoked with parameters
	  | Name         | Value                                                |
	...
	Given "client2" controller "deliveryOrderController" action "completeJourney" invoked with parameters
	  | Name    | Value                                                |
	  | orderId | {client1_deliveryOrderController_createOrder_result} |
	Given "client1" subscribed to report "customerOrderSummary" with parameters
	  | Name                     | Type   | Value   |
	  | dimension_customerUserId | String | @userId |
	  | dimension_status         | String | INPROGRESS,PLACED,ACCEPTED  |
	Then "client1" the following data is received eventually on report "customerOrderSummary"
	  | ~Action   | orderId                                              |
	  | RowAdd | {client1_deliveryOrderController_createOrder_result} |
	  | RowAdd | {client1_deliveryOrderController_createOrder_1_result} |
	  | RowAdd | {client1_deliveryOrderController_createOrder_2_result} |
