 ...
 */
public class UnionGroupMultiContextHandler implements IMultiContextHandler {
    private IDistributionManager distributionManager;
    private ExecutionPlanRunner executionPlanRunner;

    public UnionGroupMultiContextHandler(IDistributionManager distributionManager,
    ...
    public IExecutionPlan createExecutionPlan() {
        return new MultiContextGroupExecutionPlan();
    }
