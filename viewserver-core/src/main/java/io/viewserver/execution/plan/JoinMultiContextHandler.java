 ...
 */
public class JoinMultiContextHandler implements IMultiContextHandler {
    private final IDistributionManager distributionManager;
    private final ExecutionPlanRunner executionPlanRunner;
    private IExpressionParser expressionParser;

    public JoinMultiContextHandler(IDistributionManager distributionManager,
    ...
    public IExecutionPlan createExecutionPlan() {
        return new MultiContextJoinExecutionPlan(expressionParser);
    }
