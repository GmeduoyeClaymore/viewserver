...
public class DimensionGroupByStep implements IExecutionPlanStep<DimensionExecutionPlanContext>{
    @Override
    public void execute(DimensionExecutionPlanContext dimensionExecutionPlanContext) {
        String dimension = dimensionExecutionPlanContext.getDimension();

        GroupByNode groupByNode = new GroupByNode("dimensionsGroupBy")
                .withGroupByColumns(dimension)
                .withDistribution()
        ...
        dimensionExecutionPlanContext.addNodes(groupByNode);
        dimensionExecutionPlanContext.setInput(groupByNode.getName());
    }
}
