...
public class RecordUtils{
    ...
    public static void actualyAddRecord(KeyedTable operator, IRecord rec, boolean scheduled) {
        ...
        logger.debug(String.format("{} Actually adding record rec to operator {} - %s",rec.getValue(operator.getTableKeyDefinition().getKeyName())),(scheduled ? "SCHEDULED - " : "") ,operator.getPath());
