// :_KeyName_=Byte,_KeyType_=byte;_KeyName_=Short,_KeyType_=short;_KeyName_=Long,_KeyType_=long;_KeyName_=Float,_KeyType_=float;_KeyName_=Double,_KeyType_=double
...
public class Multiply_KeyName_ implements IExpression_KeyName_ {
    private final IExpression_KeyName_ lhs;
    private final IExpression_KeyName_ rhs;

    public Multiply_KeyName_(IExpression_KeyName_ lhs, IExpression_KeyName_ rhs) {
        this.lhs = lhs;
        this.rhs = rhs;
    }
