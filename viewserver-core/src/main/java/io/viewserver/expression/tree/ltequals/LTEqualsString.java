 ...
 */
public class LTEqualsString implements IExpressionBool {
    private final IExpressionString lhs;
    private final IExpressionString rhs;

    public LTEqualsString(IExpressionString lhs, IExpressionString rhs) {
        this.lhs = lhs;
        this.rhs = rhs;
    }
    ...
    public boolean getBool(int row) {
        return lhs.getString(row).compareTo(rhs.getString(row)) <= 0;
    }
