 ...
 */
public class ProjectionOperatorFactory extends ConfigurableOperatorFactoryBase<IProjectionConfig> {
    @Override
    ...
    public Class<? extends IOperator> getOperatorClass() {
        return ProjectionOperator.class;
    }
    ...
    public Class getProtoConfigDtoClass() {
        return io.viewserver.messages.config.IProjectionConfig.class;
    }

    @Override
    public Object getProtoConfigWrapper(Object configDto) {
        return new ProtoProjectionConfig((io.viewserver.messages.config.IProjectionConfig) configDto);
    }
}
