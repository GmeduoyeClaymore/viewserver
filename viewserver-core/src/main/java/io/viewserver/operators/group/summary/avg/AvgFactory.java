...
public class AvgFactory implements ISummaryFactory {
    ...
    public ISummary createSummary(String name, String target, Object[] arguments) {
        ...
        return new Avg(name, target, countColumn);
    }
    ...
    private static class Avg extends MultiTypeSummaryBase {
        private String countColumn;

        public Avg(String name, String target, String countColumn) {
            super(name, target);
        ...
        public void initialise(ISummaryContext context) {
            ...
            switch (valueColumnHolder.getType()) {
                case Byte: {
                    this.internalSummary = new AvgByte(name, target, countColumn);
                    break;
                }
                case Short: {
                    this.internalSummary = new AvgShort(name, target, countColumn);
                    break;
                }
                case Int: {
                    this.internalSummary = new AvgInt(name, target, countColumn);
                    break;
                }
                case Long: {
                    this.internalSummary = new AvgLong(name, target, countColumn);
                    break;
                }
                case Float: {
                    this.internalSummary = new AvgFloat(name, target, countColumn);
                    break;
                }
                case Double: {
                    this.internalSummary = new AvgDouble(name, target, countColumn);
                    break;
                }
                default: {
